...
public:
	...
	virtual void Update()
	{
		...
		//const char *filename = "C:/Users/teshima/Desktop/shigetomi/FleXOutput/3ten75_FrameTime_9.csv"; //é©ìÆÇ≈ñºëOïœÇÌÇÈÇÊÇ§Ç…ÇµÇΩÇ¢
		//
		//ofstream ofs(filename, ios::app);//í«â¡èëÇ´çûÇ›
		//								 //ofstream ofs(filename);//çXêVèëÇ´çûÇ›
		//								 //frame
		//ofs << realTime << "," << g_realdt*1000.f << endl;
		//cout << filename << "Ç…èëÇ´çûÇ›Ç‹ÇµÇΩ" << endl;
	}
	float realTime;
};
